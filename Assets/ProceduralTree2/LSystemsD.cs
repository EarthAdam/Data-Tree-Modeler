...
public class LSystemsD : MonoBehaviour
{
    ...
    void SetupCone()
    {
        ...
        Vector3 iniPos2 = new Vector3(segLength, 0f, 0f);
        //	Vector3 iniPos = new Vector3(0f,0.01f,0f);
        ...
        while (nBranchesToAdd > 0)
        {
            ...
            //   iniPos2 = (iniPos+new Vector3(Random.Range(-1f,1f),Random.Range(-1f,1f),Random.Range(-1f,1f))).normalized;
...
(
    ...
    randVect
                    ...
                    //     iniPos2.magnitude*(iniPos2+segmentLocRotVect[currentBranchId]).normalized;
                    segmentPos[currentBranchId] = segmentPos[currentBranchId] + (segmentRot[currentBranchId] * iniPos2);

                    //	segmentPos[currentBranchId] = segmentPos[currentBranchId]+(segmentLocRotVect[currentBranchId]);
    ...
    void DrawCone()
    {
        ...
        for (int ii = 0; ii < NN; ii++)
        {
            if (vUsed[ii] == 1)
            {
                ...
                //	vertices[ii] = vertices[ii]+segmentLocRotVect[currentBranchId];
